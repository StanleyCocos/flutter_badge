...
public class AsusHomeBadger implements Badger {
    ...
    public void executeBadge(Context context, ComponentName componentName, int badgeCount) throws ShortcutBadgeException {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            // It seems that ZenUI (com.asus.launcher) declares a content provider for badges
            // but without documentation it is hard to guess how to add badges with it.
            // Current draft implementation gives "No yet implemented" exception.
